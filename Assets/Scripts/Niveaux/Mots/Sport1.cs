...
public class Sport1 : MonoBehaviour
{
    ...
    private string[] liste = { "apnée", "gym", "arts", "aqua", "foot", "ball", "balle", "nage", "bmx", "beach", "boxe", "hand", "salsa", "samba", "surf", "sumo", "iaido", "judo", "kite", "surf", "ski", "skate", "rando", "tir", "canoë", "cerf", "char", "voile", "danse", "luge", "lutte", "lutta", "moto", "vtt", "ulm", "vol", "yoga", "polo", "echecs", "golf", "muscu", "echec", "flag", "force", "quad", "raid", "pock", "rando", "rugby" };
    private int i = 0;
    private int j = 0;
