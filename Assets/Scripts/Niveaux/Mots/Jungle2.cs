...
public class Jungle2 : MonoBehaviour
{
    ...
    private string[] liste = { "feuilles", "arbres", "racines", "lianes", "fougères", "mousson", "animaux", "humide", "sauvage", "naturel", "sauvages", "jaguar", "tigres", "tamanoir", "reptiles", "serpents", "iguanes", "singes", "tamarins", "oiseaux", "toucans", "toucan", "colibri", "insectes", "mygales", "piranha", "tarzan", "rivière", "aligator", "humidité", "araignée", "serpent", "serpents", "baobab", "mangrove", "singes", "macaque", "gorille", "exotique", "amazone", "équatorial", "savane", "canopée", "éléphant", "zebré", "zèbres", "girafe", "eucalyptus", "épiphyte"};
    private int i = 0;
    private int j = 0;
